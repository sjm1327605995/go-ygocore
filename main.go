...
func (d *Duel) RefreshExtraDef(player uint8) {
	d.RefreshExtra(d.pduel, player, 0xe81fff, 1)
}
func (d *Duel) RefreshMzoneDef(player uint8) {
	d.RefreshExtra(d.pduel, player, 0x881fff, 1)
}

func (d *Duel) RefreshSzoneDef(player uint8) {
	d.RefreshSzone(d.pduel, player, 0x681fff, 1)
}
func (d *Duel) RefreshHandDef(player uint8) {
...
func (d *Duel) RefreshExtra(pdule uintptr, player uint8, flag, use_cache int32) {
...
func (d *Duel) RefreshMzone(pdule uintptr, player uint8, flag, use_cache int32) {
...
func (d *Duel) RefreshSzone(pdule uintptr, player uint8, flag, use_cache int32) {
...
func (d *Duel) RefreshHand(pdule uintptr, player uint8, flag, use_cache int32) {
...
func (d *Duel) Analyze(msgbuffer []byte, engLen int32) int {

	var (
		offset             int
		pbuf               = &Buffer{buf: msgbuffer[:engLen]}
